...
export const style = {
  ...
  layers: [
    ...
    },
    {
      ...
      filter: [
        ...
        [
          "any",
          ["all", ["==", "class", "path"], ["in", "subclass", "cycleway"]],
          ["in", "class", "track"],
        ],
        ["!in", "brunnel", "bridge", "tunnel"],
      ],
    ...
    },
    {
      ...
      minzoom: 16,
      filter: ["all", ["==", "$type", "Point"], ["!=", "entrance", ""]],
      layout: {
        "text-field": [
          "concat",
          ["get", "housenumber"],
          ["coalesce", ["get", "unit"], ["get", "ref"]],
        ],
        "text-size": {
          stops: [
            [15, 8],
    ...
    },
    {
      ...
      filter: [
        ...
        [
          "any",
          ["in", "class", "school", "college", "place_of_worship", "swimming"],
          [
            "in",
            "subclass",
            "hotel",
    ...
    },
    {
      ...
      "source-layer": "park",
      minzoom: 14,
      filter: ["all", ["!=", "$type", "Point"], ["in", "class", "park"]],
      layout: {
        "text-size": 11,
        "text-max-width": 8,
    ...
    },
    {
      ...
      filter: [
        "all",
        ["==", "$type", "Point"],
        ["in", "class", "water", "lake", "bay", "strait", "cape"],
      ],
      layout: {
  ...
  sources: {
    vector: {
      type: "vector",
      url: `https://api.digitransit.fi/map/v2/hsl-vector-map/index.json?digitransit-subscription-key=${
        import.meta.env.VITE_DIGITRANSIT_SUBSCRIPTION_KEY
      }`,
    },
  },
